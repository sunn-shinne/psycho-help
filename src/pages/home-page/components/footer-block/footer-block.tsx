  ...
  return (
    <div>
      <div style={styles.wrapper}>
        ...
        <div style={styles.flexWrap}>
          ...
          <div style={styles.socials}>
            <div style={styles.iconBox}>
              <a href="">
                <img style={styles.icon} src={Ok} alt="icon" />
              </a>
            </div>
            <div style={styles.iconBox}>
              <a href="">
                <img style={styles.icon} src={Youtube} alt="icon" />
              </a>
            </div>
            <div style={styles.iconBox}>
              <a href="">
                <img style={styles.icon} src={Vk} alt="icon" />
              </a>
            </div>
            <div style={styles.iconBox}>
              <a href="">
                <img style={styles.icon} src={Tg} alt="icon" />
              </a>
            </div>
          </div>
        </div>
        <h3>
          E-mail:{' '}
          <a style={styles.a} href="mailto:psycholog@mospolytech.ru">
        ...
        >
          ...
          >
            &copy; 2024 федеральное государственное автономное образовательное учреждение высшего
            образования &laquo;Московский политехнический университет&raquo;,
            <br />
            Московский Политех
          </p>
        </div>
