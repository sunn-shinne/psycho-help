    ...
    <div>
      <div className="wrapper" style={styles.wrapper}>
        ...
        <div style={styles.textBlock}>
          <h3 style={{ marginRight: 'calc((1vh + 1vw) / 2)' }}>—</h3>
          <p>
            Горячая линия Московской службы психологической помощи населению - 8 (495) 051  (с
            городского телефона) и 051 (с мобильного телефона) <br />
        ...
        <div style={styles.textBlock}>
          <h3 style={{ marginRight: 'calc((1vh + 1vw) / 2)' }}>—</h3>
          <p>
            Горячая линия по оказанию психологической помощи студенческой молодежи организованной
            Минобрнауки России - 8 (800) 222-55-71 <br />
            <strong>Режим работы: круглосуточно</strong>
          </p>
        </div>
        <div style={styles.textBlock}>
